import { todosByCompleted } from './todos-by-completed.js';

describe('todosByCompleted: fetches todos queried by completeness', () => {
  ...
  it('should fetch 110 incomplete todos', async () => {
    const incompleteTodos = await todosByCompleted(false);
